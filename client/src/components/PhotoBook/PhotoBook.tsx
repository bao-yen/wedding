...
const PHOTOS = [
  ...
  import.meta.env.BASE_URL + "image/album/3.JPG",
  import.meta.env.BASE_URL + "image/album/4.jpeg",
  import.meta.env.BASE_URL + "image/album/5.jpeg",
  import.meta.env.BASE_URL + "image/album/6.jpg",
  import.meta.env.BASE_URL + "image/album/7.jpg",
  import.meta.env.BASE_URL + "image/album/8.jpeg",
  import.meta.env.BASE_URL + "image/album/9.jpg",
  import.meta.env.BASE_URL + "image/album/10.jpg",
  import.meta.env.BASE_URL + "image/album/11.jpg",
  import.meta.env.BASE_URL + "image/album/12.jpg",
  import.meta.env.BASE_URL + "image/album/13.jpg",
  import.meta.env.BASE_URL + "image/album/14.jpg",
  import.meta.env.BASE_URL + "image/album/15.jpg",
];
